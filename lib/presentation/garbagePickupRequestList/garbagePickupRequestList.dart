...
class GarbagePickupRequestList extends StatefulWidget {
  ...
  @override
  State<GarbagePickupRequestList> createState() =>
      _GarbagePickupRequestListState();
}
...
class _GarbagePickupRequestListState extends State<GarbagePickupRequestList> {
  ...
  cityzenRequestDetails() async {
    cityzenRequestDetail =
        await CitizenRequestDetailsRepo().citizenRequestDetails(context);
    print('-----39----xx --cityzenRequestDetail----$cityzenRequestDetail');
    ...
    return Scaffold(
        ...
        body: isLoading
            ...
            : (cityzenRequestDetail == null || cityzenRequestDetail!.isEmpty)
                ? NoDataScreenPage()
                : ListView.builder(
                    itemCount: cityzenRequestDetail?.length ?? 0,
                                  ...
                                  child: Stack(
                                    children: <Widget>[
                                      InkWell(
                                        onTap: () {
                                          print(
                                              "---Open this image to full Dialog--");
                                        ...
                                        child: Container(
                                          ...
                                          child: ClipRRect(
                                            borderRadius: BorderRadius.circular(10),
                                            // Ensure rounded corners apply to the child
                                            child: Image.network(
                                              item['sImage_1'],
                                  ...
                                  child: IntrinsicWidth(
                                    ...
                                    child: Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text("Status : ${item['iStatus']}",
                                            style: AppTextStyle
