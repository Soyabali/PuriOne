...
class GetAdvertismentRequestStatusRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> getAdvertisementStatus(BuildContext context) async {
    ...
    try {
      ...
      var endPoint = "GetAdvertismentRequestStatus/GetAdvertismentRequestStatus";
