...
class GetWardDetailRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> getWardDerail(BuildContext context, sWardCode) async {

    SharedPreferences prefs = await SharedPreferences.getInstance();
    String? sToken = prefs.getString('sToken');
    String? iUserId = prefs.getString('iUserId');
    String? contactNo = prefs.getString('sContactNo');
    print("----sWardCode---$sWardCode");
    ...
    try {
      ...
      var endPoint = "GetWardDetails/GetWardDetails";
      ...
      if (response.statusCode == 200) {
        ...
        if (dataList != null) {
          ...
          print("Ward Detail : $pendingInternalComplaintList");
