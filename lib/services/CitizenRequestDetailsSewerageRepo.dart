...
class CitizenRequestDetailSewergeRepo {

  GeneralFunction generalFunction = GeneralFunction();

  Future<List<Map<String, dynamic>>?> citizenRequestDetailsSewarge(BuildContext context) async {
    ...
    try {
      ...
      var endPoint = "CitizenRequestDetails/CitizenRequestDetails";
